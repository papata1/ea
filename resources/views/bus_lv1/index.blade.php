    ...
    <div class="panel panel-default" >
        ...
        <div class="panel-body" style="margin-right:20px;">
            ...
            <select id="master" name="master" class="form-control info">
                ...
                <option value="" href="{{ url ('lv1') }}" selected=\"selected\">กระบวนการระดับ 1</option>
...
<class="container">
  			<div class="form-group"><h1 style="font-size:38px;">กระบวนการระดับ1</h1></div>
...
<div class="panel panel-default" >
    <div class="panel-heading">
        <div class="col-lg-3">ตารางกระบวนการระดับที่ 1</div><div class="col-lg-7"></div>{{ link_to_route('lv1.create','เพิ่ม',null,['class'=>'btn btn-success']) }}
    </div>
    <!-- /.panel-heading -->
    <div class="panel-body" style="margin-right:20px;">
                ...
                <tr>
                    <td>{{ $de->short}}</td>
                     <td>{{ $de->name}}  </td>
                         ...
                         <td>
                           {!! Form::open(array('route'=>['lv1.destroy',$de->id],'method'=>'DELETE')) !!}
                        {{ link_to_route('lv1.edit','แก้ไข',[$de->id],['class'=>'btn btn-primary','id'=>'a']) }}
