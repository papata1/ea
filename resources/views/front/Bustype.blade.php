										...
										<table class="table table-bordered table-hover" id="myTable">
											<thead>
												<tr>
													...
													<th><center>ระดับกระบวนการ</center></th>
											...
											<tbody>
												...
												<tr onclick="document.location = '<?php echo url('main/BusDetail/'.$model->blid); ?>';">
													<td width="50">{{ $model->lv1 }}{{ $model->lv2 }}{{ $model->lv3 }}{{ $model->blid }}</td>
													<td>{{ $model->blname }}</td>
													<td>- {{ $model->n1 }}<br>- {{ $model->n2 }}<br>- {{ $model->n3 }}</td>
													<td>
														@foreach($model2 as $modell2)
														<?php
														if($model->blid == $modell2->compblid)
														{
