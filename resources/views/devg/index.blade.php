...
<div class="panel panel-default" >
    ...
    <div class="panel-body" style="margin-right:20px;">
        ...
        <select id="master" name="master" class="form-control info">
            ...
            <option value="i" href="{{ url ('devg') }}"  selected=\"selected\">บริษัทที่พัฒนา</option>
                 <option value="" href="{{ url ('buslv1') }}">กระบวนการระดับ 1</option>
                <option value="" href="{{ url ('buslv2') }}" >กระบวนการระดับ 2</option>
                <option value="" href="{{ url ('buslv3') }}">กระบวนการระดับ 3</option>
        </select>
    </div></div>
    </div>
    <!-- /.panel-body -->
...
<class="container">
  			<div class="form-group"><h1 style="font-size:38px;">บริษัทที่พัฒนา
                </h1></div>
    ...
    <form action="devgImport" method = "post" enctype="multipart/form-data" >
        ...
        <div class="col-lg-5">
            <div class="panel panel-default" >
                <div class="panel-heading">
                    <button id="download" class="btn btn-default ">ดาวน์โหลดที่ใช้ในการนำเข้าข้อมูล</button>
                </div>
...
<div class="panel panel-default" >
    <div class="panel-heading">
        <div class="col-lg-2">ตารางบริษัทที่พัฒนา</div><div class="col-lg-8"></div>{{ link_to_route('devg.create','เพิ่มบริษัทพัฒนา',null,['class'=>'btn btn-success']) }}
    </div>
    <!-- /.panel-heading -->
    <div class="panel-body" style="margin-right:20px;">
        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
          <thead>
            <tr>
              ...
              <tbody>
                @foreach($devg1 as $devg)
                <tr>
                     <td>{{ $devg->name}}  </td>

                    <td>
                           {!! Form::open(array('route'=>['devg.destroy',$devg->id],'method'=>'DELETE')) !!}
                        {{ link_to_route('devg.edit','แก้ไข',[$devg->id],['class'=>'btn btn-primary','id'=>'a']) }}
