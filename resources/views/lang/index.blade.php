...
<div class="panel panel-default" >
    ...
    <div class="panel-body" style="margin-right:20px;">
        ...
        <select id="master" name="master" class="form-control info">
            ...
            <option value="r" href="{{ url ('lang') }}" selected=\"selected\">ภาษาที่ใช้พัฒนา</option>
            ...
            <option value="" href="{{ url ('InDat') }}">ตัวย่อข้อมูล</option>
                ...
                <option value="" href="{{ url ('lv3') }}">กระบวนการระดับ 3</option>
        </select>
    </div></div>
    </div>
    <!-- /.panel-body -->
...
<class="container">
  			<div class="form-group"><h1 style="font-size:38px;">ภาษาที่ใช้พัฒนา</h1></div>
    ...
    <form action="langImport" method = "post" enctype="multipart/form-data" >
...
<div class="panel panel-default" >
    <div class="panel-heading">
      <div class="col-lg-3">ตารางภาษาที่ใช้พัฒนา</div><div class="col-lg-6"></div>{{ link_to_route('lang.create','เพิ่มภาษาที่ใช้พัฒนา',null,['class'=>'btn btn-success']) }}
    </div>
    <!-- /.panel-heading -->
    <div class="panel-body" style="margin-right:20px;">
            ...
            <tr>
              ...
              <tbody>
                ...
                <tr>
                     <td>{{ $lang->name}}  </td>
                         <td>
                           {!! Form::open(array('route'=>['lang.destroy',$lang->id],'method'=>'DELETE')) !!}
                        {{ link_to_route('lang.edit','แก้ไข',[$lang->id],['class'=>'btn btn-primary','id'=>'a']) }}
